        ...
        <form method="POST" action="{{ route('projects.tasks.store', $project) }}">
            ...
            <div class="mb-4">
                ...
                <textarea name="descripcion" rows="3"
                          class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400">{{ old('descripcion') }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    @error('prioridad') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
            </div>
